...
#+BEGIN_SRC emacs-lisp
(global-set-key (kbd "<XF86Launch1>") 'audio/mute)
...
#+BEGIN_SRC emacs-lisp
  (use-package emms
    ...
    :config
      ...
      (setq emms-player-mpd-music-directory "/home/driva/Music")
...
**** If stuck in folder
     Reset the emms cache to the top of the mpd library 

#+BEGIN_SRC emacs-lisp
     (global-set-key (kbd "s-m t") 'emms-cache-set-from-mpd-all)
#+END_SRC

**** Cover Art
     EMMS uses cover_small.jpg (100px * 100px) and cover_med.jpg (200px * 200px) as cover art.
     To make the overall appearance more consistent we set placeholders for albums that miss cover art.

#+BEGIN_SRC emacs-lisp
  (setq emms-browser-default-covers
    (list (expand-file-name "images/cover_small.jpg" (file-name-directory load-file-name)) (expand-file-name "images/cover_med.jpg" (file-name-directory load-file-name)) nil))
#+END_SRC
